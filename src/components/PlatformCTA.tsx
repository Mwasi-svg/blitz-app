...
export const PlatformCTA = () => {
    return (
        <section id="platforms" className="py-16 sm:py-20 lg:py-24 px-4 sm:px-6 bg-blitz-bg">
                ...
                >
                    <div className="relative bg-[#0E1623] rounded-2xl sm:rounded-[3rem] overflow-hidden px-4 sm:px-8 py-12 sm:py-16 md:px-20 md:py-24 text-center">
                        ...
                        <div className="relative z-10 max-w-6xl mx-auto">
                            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-medium text-white tracking-tighter mb-4 sm:mb-6 lg:mb-8 leading-tight">
                            ...
                            <p className="text-base sm:text-lg lg:text-xl text-slate-400 mb-8 sm:mb-12 lg:mb-16 max-w-2xl mx-auto leading-relaxed">
                                Download Blitz for your preferred platform. Free versions for your personal use.
                            </p>

                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 max-w-4xl mx-auto">
                                <a href="#" className="group flex flex-col items-center justify-center p-5 sm:p-6 bg-[#0E1623] hover:bg-[#1C2330] border border-white/5 rounded-xl sm:rounded-2xl transition-all hover:-translate-y-1 min-h-[100px]">
                            ...
                            <div className="mt-10 sm:mt-12 lg:mt-16 flex flex-col items-center gap-4 text-center">
